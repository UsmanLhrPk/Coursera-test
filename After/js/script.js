$(function () { // Same as docuent.addEventListener("DOMContentLoaded"...,)

	// Same as docuemnt.querySelector("#navbarToogle").addEventListener("blur"...,)
	...
	// In firefox and Safari, the click event dosen't retain the focus
...
(function (global) {
	...
	// Convenience function for insertign innerHTML for 'select'
	...
	document.addEventListener("DOMContentLoaded", function (event) {
		...
		// On frist load, show home view
		showLoading("#main-content");
		$ajaxUtils.sendGetRequest(
			homeHtml, 
			function (responseTest) {
				document.querySelector("#main-content")
				.innerHTML = responseTest;
			},
			false);
	});
...
function buildMenuItemsViewHtml (categoryMenuItems, 
	...
	menuItemsTitleHtml =
		insertProperty(menuItemsTitleHtml,
									 ...
									 categoryMenuItems.category.speical_instructions);
